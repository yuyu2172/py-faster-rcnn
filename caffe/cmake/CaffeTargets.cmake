...
set_target_properties(caffe PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/local/cuda-8.0/include;/usr/local/cuda-8.0/include;/home/leus/miniconda2/envs/general/include;/home/leus/miniconda2/envs/general/include/opencv;/usr/include;/usr/include/atlas;/usr/include;/home/leus/playground/py-faster-rcnn/caffe-fast-rcnn/include"
)
...
set_target_properties(caffe PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "proto;/usr/lib/x86_64-linux-gnu/libglog.so;/usr/lib/x86_64-linux-gnu/libgflags.so;/usr/lib/x86_64-linux-gnu/libprotobuf.so;-lpthread;/usr/lib/x86_64-linux-gnu/libhdf5_hl.so;/usr/lib/x86_64-linux-gnu/libhdf5.so;/usr/lib/x86_64-linux-gnu/libhdf5_hl.so;/usr/lib/x86_64-linux-gnu/libhdf5.so;/usr/lib/x86_64-linux-gnu/liblmdb.so;/usr/lib/x86_64-linux-gnu/libleveldb.so;/usr/local/cuda-8.0/lib64/libcudart.so;/usr/local/cuda-8.0/lib64/libcurand.so;/usr/local/cuda-8.0/lib64/libcublas.so;/usr/local/cuda-8.0/lib64/libcudnn.so;opencv_core;opencv_highgui;opencv_imgproc;opencv_imgcodecs;/usr/lib/liblapack.so;/usr/lib/libcblas.so;/usr/lib/libatlas.so;/usr/lib/x86_64-linux-gnu/libboost_python.so"
  IMPORTED_LOCATION_RELEASE "/home/leus/playground/py-faster-rcnn/caffe-fast-rcnn/cmake/lib/libcaffe.so.1.0.0"
...
set_target_properties(proto PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/leus/playground/py-faster-rcnn/caffe-fast-rcnn/cmake/lib/libproto.a"
  )
